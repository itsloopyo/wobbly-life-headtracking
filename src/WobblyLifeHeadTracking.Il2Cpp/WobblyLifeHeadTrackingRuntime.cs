...
namespace WobblyLifeHeadTracking
{
    public sealed class WobblyLifeHeadTrackingRuntime : MonoBehaviour
    {
        ...
        {
            bool active = _trackingEnabled && _wasTrackingAllowed;
            _cameraController.IsTrackingActive = active;
        ...
        {
            bool isTrackingAllowed = _gameState.IsInGameplay;
        ...
        public bool IsConnected => _cameraController != null && _cameraController.IsAnyPlayerReceiving();
